...
│   ├── 05-declaration-w...ce.typ	# the declaration on working space as specified by the DFG
...
│       ├── <03-project2-id>.typ
│       └── ...
├── crc-2025-cover.typ			# the template for the cover of the printed version of the proposal
...
├── dfg-research-areas.typ		# the DFG research areas version 2024-2028
├── doc/				# the documentation of the proposal document, formerly README-<X>.md files
│   ├── ...
│   ├── justfile			# a main executive for the compilation of the proposal documentation
│   ├── Makefile			# a main executive for the compilation of the proposal documentation
│   └── ...
├── img/				# the directory to put image and graphics files
├── justfile				# a main executive for the setup and compilation of the document, see "Document setup"
├── LICENSE				# the license file for this repository
├── Makefile				# a main executive for the setup and compilation of the document, see "Document setup"
...
│   │   └── chicago-aut....csl		# allows to add the variable "annote" to a bibkey which results in boldfacing the title to highlight important publications
