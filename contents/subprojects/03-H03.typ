...
== Differentiation from other funded projects of the project leader(s)
...
This project has been funded since `month` `YYYY` under another DFG programme (reference number <x>) and shall be integrated into the Collaborative Research Centre.
// <Or:> A funding proposal for the project has been submitted under another DFG programme (reference number <x>). 
// <Or>: This project is currently not funded and no funding proposal has been submitted.
